/*A react component that fetches campaigns related to environmental specific technology 
...
const EchoTechCampaigns = (props: Props) => {
    ...
    useEffect(() => {
        /*dispatch the action to get campaigns specific to eco-tech niche */
        dispatch(getNicheSpecificCampaign('Eco-Tech'));
    }, [dispatch]);
...
export default EchoTechCampaigns