/*A react component that fetches campaigns related to environmental education 
...
const EcoEducationCampaigns = (props: Props) => {
    ...
    useEffect(() => {
        /*dispatch the action to get campaigns specific to eco-education niche */
        dispatch(getNicheSpecificCampaign('Eco-Education'));
    }, [dispatch]);
...
export default EcoEducationCampaigns